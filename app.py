...
def guide_me_on(input):
    ...
    if input !='':
        prompt=f'''Act as a Dieatician , Health Coach , Psychaterist and Expert and adress the queries , 
        questions,apprehension realted to health,fitness,disease and things related to this with 
        empathy towards the user. If any query is not related to healthcare you shouls pass the messege-
        'Sorry I am Healthcare AI , I cant help with This...',Dont Prescribe any medicine or chemical salt
        ,even if someone ask for medicine , just say -'I am an AI Bot , Consult a Human Doctor for Medicine 
        consultation'.'''
